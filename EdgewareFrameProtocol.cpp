...
//Destructor. Keep it visible for future use
...
//The protocol is currently not guarding for that.
        ...
        if (numCandidatesToDeliver && fistDelivery) {
            ...
            if (clearHeadOfLineBuckets) {
                for (auto &x: candidates) {
                    recieveCallback(bucketList[x.bucket].bucketData, bucketList[x.bucket].dataContent, x.broken, x.pts,
                                    x.code);
